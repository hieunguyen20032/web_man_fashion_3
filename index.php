...
<body>
    ...
    <div id="wapper-body" style="padding-top: 30px;">
        ...
        render_ai_recommendations($user_id, null, 'GỢI Ý DÀNH RIÊNG CHO BẠN', 8, 'ai-recommendations-home');
        ?>
        ...
        $(document).ready(function() {
            ...
            $("#themeContainer .wrapper-style .time  #save-time").click(function() {
                ...
                if (id == "") {
                    ...
                    $("#themeContainer .wrapper-style .time #error").css({
                        "color": "#bd0103",
                        "font-weight": 700
                    });
                } else if (id == "default") {
            ...
            $('.body .cart').click(function() {
                ...
                $.get("xuli-seeproduct/session-display.php", {
