	...
	<div class="container">
		<div class="row" style="background: #2E2E2E;padding: 25px 0">
			...
			<div class="col-xs-12 col-sm-5 wapper1">
				<?php
				$query_logo_footer = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "logo_footer"';
				...
				if( mysqli_num_rows($result_logo_footer) > 0 ) {
					...
					echo  '<img src="'. $gia_tri .'" class="img-responsive">';
				}
				?>  
				<!-- <img src="image/logo-bottom.png" class="img-responsive"> -->
				<p class="nd">
					<?php
					$query_description = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "description"';
				...
				<div class="col-xs-12 col-sm-3 wapper3">
					...
					<ul>
						...
						if( mysqli_num_rows($result_email) > 0 ) { 
							...
							$array_email = explode(' ', trim($gia_tri));
	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="div-footer">Copyright 2023 · by <span>ToTo</span> All rights reserved</div>
			</div>
		</div>
	</footer>
