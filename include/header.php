<div class="body">
    <div class="top-bar">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-sm-4 top-bar-left">
                        <ul class="list-unstyled">
                            <li class="hidden-xs">
                                <i class="glyphicon glyphicon-earphone"></i>
                                <?php
                                $query_phone = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "phone"';
                                ...
                                if( mysqli_num_rows($result_phone) > 0 ) {
                                    ...
                                    $array_phone = explode(' ', trim($gia_tri));
                                    $stt=0;
                        ...
                        <li class="hidden-xs hidden-sm hidden-md">
                            ...
                            <?php
                            $query_email = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "email"';
                ...
                <div class="col-xs-12 col-sm-8 top-bar-right pull-right">
                    <ul class="list-unstyled">
                        ...
                        <?php
                            ...
                            ?>   
                                <li> <span style="color:bisque;font-size:18px">Hi <?php echo($_SESSION['fullname'])?> | </span> <a href="don-hang-da-dat.php">Xem đơn hàng</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-3 logo-header">
                <a href="index.php">
                 <?php
                 $query_logo_header = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "logo_header"';
        ...
        <div class="hidden-xs col-sm-7 menu-header">
            <ul>
                <?php
                $query_category = "SELECT * FROM tb_danh_muc WHERE id_cha = 0";
                ...
                while ($category = mysqli_fetch_array($result_category, MYSQLI_ASSOC)) {
                    ...
                    <li>
                        ...
                        href="sp-category.php?category=<?php echo $category['id_danh_muc']; ?>"><?php echo $category['ten_danh_muc']; ?></a>
                        <?php
                        $query_category_c = "SELECT * FROM tb_danh_muc WHERE id_cha={$category['id_danh_muc']}";
                                    ...
                                    <div class="row">
                                        ...
                                        while ($category_c = mysqli_fetch_array($result_category_c, MYSQLI_ASSOC)) {
                                            ...
                                            <div class="col-sm-3 item-item-menu-header">
                                                ...
                                                <?php
                                                $query_category_c1 = "SELECT * FROM tb_danh_muc WHERE id_cha={$category_c['id_danh_muc']}";
                                                ...
                                                while ($category_c1 = mysqli_fetch_array($result_category_c1, MYSQLI_ASSOC)) {
                                                    ?>
                                                    <a href="sp-category.php?category=<?php echo $category_c1['id_danh_muc'] ?>"><?php echo $category_c1['ten_danh_muc'] ?></a>
                                                    <br>
                                                    <?php
                                                }
                                                ?>
        ...
        <a href="thongtingiohang.php" class="cart-cart"><i
          ...
          if (isset($_SESSION['cart']) or !empty($_SESSION['cart'])) {
            foreach ($_SESSION['cart'] as $value) {
                ...
                product="<?php echo $value['id_san_pham']; ?>">
                <div class="col-xs-5 cart-img ">
                    <a href="product.php?id=<?php echo $value['id_san_pham']; ?>">
               ...
               <div class="title-product"><a
                href="product.php?id=<?php echo $value['id_san_pham']; ?>"><?php echo $value['ten_san_pham'] ?></a></div>
                ...
                class="gia"><?php echo $value['gia_khuyen_mai'] ?></span>
            </div>
                ...
                <div class="list">
                    <ul>
                       ...
                       while ($category = mysqli_fetch_array($result_category, MYSQLI_ASSOC)) {
                        ?>
                        <li class="title-menu">
                            <a href="sp-category.php?id<?php echo $category['id_danh_muc']; ?>"><?php echo $category['ten_danh_muc'] ?></a>
                            <ul class="item-title-menu">
                               ...
                               if (mysqli_num_rows($result_category_c) > 1) {
                                while ($category_c = mysqli_fetch_array($result_category_c, MYSQLI_ASSOC)) {
                                    ...
                                    ?>
                                    <li class="title"><h4><a href="sp-category.php?id<?php echo $category_c['id_danh_muc']; ?>"><?php echo $category_c['ten_danh_muc'] ?></a></h4></li>
                                    <?php
                                    $query_category_c1 = "SELECT * FROM tb_danh_muc WHERE id_cha={$category_c['id_danh_muc']}";
                                    $result_category_c1 = mysqli_query($dbc, $query_category_c1);
                                    kt_query($query_category_c1, $result_category_c1);
                                    while ($category_c1 = mysqli_fetch_array($result_category_c1, MYSQLI_ASSOC)) {
                                        ?>
                                        <li><a href="sp-category.php?id<?php echo $category_c1['id_danh_muc']; ?>"><?php echo $category_c1['ten_danh_muc'] ?></a></li>
                                        <?php 
                                    }
                                    ?>
