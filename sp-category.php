...
<body style="margin-top: -20px">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <?php
                        $query_category1 = "SELECT id_danh_muc,ten_danh_muc,id_cha FROM tb_danh_muc WHERE  id_danh_muc={$id_category}";
                        ...
                        if($parent_id1 !=0){
                            $query_category2 = "SELECT id_danh_muc,ten_danh_muc,id_cha FROM tb_danh_muc WHERE  id_danh_muc={$parent_id1}";
                            ...
                            if($parent_id2 !=0){
                                $query_category3 = "SELECT id_danh_muc,ten_danh_muc,id_cha FROM tb_danh_muc WHERE  id_danh_muc={$parent_id2}";
    ...
    <?php
    $query_category = "SELECT id_danh_muc,ten_danh_muc,id_cha FROM tb_danh_muc WHERE  id_danh_muc={$id_category}";
            ...
            <div class="row">
                <div class="col-md-9 col-sm-8">
                    ...
                    if(isset($_GET['p']) && filter_var($_GET['p'],FILTER_VALIDATE_INT,array('min_range' =>1))){
                        ...
                        $query_pg="SELECT COUNT(id_danh_muc) FROM tb_san_pham WHERE id_danh_muc IN ($id)";
                    ...
                    $query_sp = "SELECT * FROM tb_san_pham WHERE id_danh_muc IN ($id) LIMIT {$start},{$limit}";
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 text-center">
                            <div class="khunghinh" >
                                ...
                                <div class="text-center name"><a href=""><?php echo $product['ten_san_pham']; ?></a></div>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 sibar-right">
                    ...
                    <h5>SẢN PHẨM HOT</h5>
                    <?php
                    $query_sp_hot = "SELECT * FROM tb_san_pham  ORDER BY luot_xem DESC LIMIT  0,5";
                    ...
                    while ($product = mysqli_fetch_array($result_sp_hot, MYSQLI_ASSOC)) {
                        ...
                        <div class="col-xs-12 product-hot">
                            ...
                            <div class="col-xs-8 text-left">
                                <a href=""><?php echo $product['ten_san_pham']; ?></a>
                            </div>
                        </div>
                        <?php
                    }
                            ...
                            if(isset($_SESSION['seen']) or !empty($_SESSION['seen'])) {
                                foreach ($_SESSION['seen'] as $value) {
                                    ...
                                    <div class="col-xs-12 product-hot">
                                        ...
                                        <div class="col-xs-8">
                                            <a href="product.php?id=<?php echo $value['id_san_pham']; ?>"><?php echo $value['ten_san_pham'] ?? ""; ?></a>
                                        </div>
                                    </div>
                                    <?php
                                }
