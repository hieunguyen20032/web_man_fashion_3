...
<body style="margin-top: -20px;">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        $query_sp = "SELECT id_danh_muc,ten_san_pham,luot_xem FROM tb_san_pham WHERE id_san_pham={$id}";
                        ...
                        ++$view_product;
                        $query_view = "UPDATE tb_san_pham SET luot_xem = {$view_product} WHERE id_san_pham={$id}";
                        $result_view = mysqli_query($dbc, $query_view);

                        $query_category_c1 = "SELECT id_danh_muc,ten_danh_muc,id_cha FROM tb_danh_muc WHERE id_danh_muc={$id_category}";
    ...
    $query_sp = "SELECT * FROM tb_san_pham WHERE id_san_pham={$id}";
    $result_sp = mysqli_query($dbc, $query_sp);
    kt_query($query_sp, $result_sp);
    while ($product = mysqli_fetch_array($result_sp, MYSQLI_ASSOC)) {
    ?>
        <div class="see-product" style="background: #666" product="<?php echo $product['id_san_pham']; ?>">
            <div class="container container-see">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-xs-12 right">
                        <h1 class="title-product-see"><?php echo $product['ten_san_pham']; ?></h1>
                        <div class="price"
                            id="quickBuyPrice"><?php echo number_format($product['gia_khuyen_mai'], 0, ',', '.'); ?></div>
                        <div class="stock"> Tình trạng: <span id="quickBuyStock"><?php if ($product['trang_thai_san_pham'] == 1) {
                                                                                        echo "Còn hàng";
                                                                                    } else {
                                                                                        echo "Hết hàng";
                                                                                    } ?></span></div>
                        ...
                        <p id="quickBuyHighlight"><?php echo $product['mo_ta_san_pham']; ?></p>
                        <hr>
                                ...
                                <div class="col-xs-12 option1">
                                    <div class="row">
                                        <select name="size" class="select select-size" style="text-transform: uppercase;">
                                            <?php
                                            $array_size = (unserialize($product['kich_co_san_pham']));
                        ...
                        <div class="col-xs-12 diachi">
                            ...
                            <ul>
                                <?php
                                $query_adress = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "adress"';
                                ...
                                if (mysqli_num_rows($result_adress) > 0) {
                                    ...
                                    $array_adress = explode("$%^$%^", trim($gia_tri, "$%^$%^"));
                                    echo '<li>' . $array_adress[0] . '</li>';
                                }
                                ?>
                                <li>(Ngoài những địa chỉ mua hàng trực tiếp
                                    <?php
                                    $query_description = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "name"';
                        ...
                        <div class="col-xs-12">
                            <div class="row  cam-ket">
                                ...
                                thiết kế theo xu hướng thời trang 2023 của thương hiệu <?php
                                                                                        $query_description = 'SELECT gia_tri FROM tb_thong_tin WHERE ten = "name"';
                                                                                        $result_description = mysqli_query($dbc, $query_description);
                                                                                        if (mysqli_num_rows($result_description) > 0) {
                                                                                            extract(mysqli_fetch_array($result_description, MYSQLI_ASSOC));
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-12 wp" style="margin-top: 20px">
                    <div class="row width" style="overflow: hidden;">
                        <div class="wapper">
                            <?php
                            $query_product = "SELECT * FROM tb_san_pham WHERE id_danh_muc={$id_category} && id_san_pham !={$id}";
                            ...
                            ?>
                                <div class="item">
                                    <div class="khung-img">
                                        <div class="item-img">
                                            ...
                                            ?>
                                                <a href="product.php?id=<?php echo $product['id_san_pham']; ?>">
                                                    <img title="<?php echo $product['ten_san_pham']; ?>" src="<?php echo $value; ?>" class="img<?php if ($i == 1) {
                                                                                                                                                    echo '_1';
                                                                                                                                                } ?>">
                                                </a>
                                        ...
                                        <div class="text-center name"><a href=""><?php echo $product['ten_san_pham']; ?></a>
                                        </div>
                                        <div class="text-center price"><?php echo number_format($product['gia_khuyen_mai'], 0, ',', '.'); ?></div>
                                        <div class="button-product">
                                            <a href="product.php?id=<?php echo $product['id_san_pham']; ?>" class="cart">
                                                <i class="glyphicon glyphicon-shopping-cart"></i><span>Mua ngay</span>
                                            </a>
                                            <a href="product.php?id=<?php echo $product['id_san_pham']; ?>" class="see">
    ...
    <!-- AI Recommendation Section for Product Detail Page -->
    <?php
    $user_id = isset($_SESSION['id']) ? $_SESSION['id'] : null;
    render_ai_recommendations($user_id, $id, 'CÓ THỂ BẠN CŨNG THÍCH', 8, 'ai-recommendations-product');
    ?>

    <?php
    $query_product = "SELECT * FROM tb_san_pham WHERE id_san_pham={$id}";
    $result_product = mysqli_query($dbc, $query_product);
    kt_query($query_product, $result_product);
    while ($product = mysqli_fetch_array($result_product, MYSQLI_ASSOC)) {
    ?>
        <div class="dat-hang" style="<?php if (isset($_SESSION['display'])) {
                                        ...
                                        ?>" product="<?php echo $product['id_san_pham']; ?>">

            <div class="modal-dathang">
                <div class="col-xs-12 name-dt"><?php echo $product['ten_san_pham']; ?>
                    <div class="close-dt">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-9">
                        <div class="price-dt"><?php echo number_format($product['gia_khuyen_mai'], 0, ',', '.'); ?></div>
                        <hr>
