    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        <form name="frmadd-video" method="post" class="frm-image" action="" enctype="multipart/form-data">
            ...
            if(isset($_POST['submit'])){
                ...
                $query = "SELECT * FROM tb_thong_tin WHERE ten='image_1'";
                $result = mysqli_query($dbc, $query);
                if( mysqli_num_rows($result) > 0 ) {
                    if (!empty($_FILES['img1']['name'])) {
                        $query_image = "UPDATE tb_thong_tin SET  
                        gia_tri = '{$link_img}'
                        WHERE ten ='image_1'";
                    ...
                    $query_category = "UPDATE tb_thong_tin SET  
                    gia_tri = '{$id_category}'
                    WHERE ten='category_1'";
                    $result_category = mysqli_query($dbc, $query_category);
                } else {
                    if (!empty($_FILES['img1']['name'])) {
                        $query_image = "INSERT INTO  tb_thong_tin(ten,gia_tri)
                        VALUES('image_1','{$link_img}')";
                        $result_image = mysqli_query($dbc, $query_image);
                    }
                    $query_category = "INSERT INTO  tb_thong_tin(ten,gia_tri)
                ...
                $query = "SELECT * FROM tb_thong_tin WHERE ten='image_2'";
                $result = mysqli_query($dbc, $query);
                if( mysqli_num_rows($result) > 0 ) {
                ...
                $query = "SELECT * FROM tb_thong_tin WHERE ten='image_3'";
                $result = mysqli_query($dbc, $query);
                if( mysqli_num_rows($result) > 0 ) {
                ...
                $query = "SELECT * FROM tb_thong_tin WHERE ten='image_4'";
                $result = mysqli_query($dbc, $query);
                if( mysqli_num_rows($result) > 0 ) {
