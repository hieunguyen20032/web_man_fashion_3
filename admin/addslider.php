...
if(isset($_POST['submit'])) {
	...
	if ( isset($_FILES['img']) ) {	
	    ...
	    $query = "SELECT * FROM tb_thong_tin WHERE ten='slider'";
	    $result = mysqli_query( $dbc, $query );
	    if( mysqli_num_rows($result) > 0 ) {
	    	$query_ud = "UPDATE tb_thong_tin SET gia_tri='{$link_image}' WHERE ten='slider'";
	    	...
	    	$query_is = "INSERT INTO  tb_thong_tin(ten,gia_tri) VALUES('slider', '{$link_image}')";
	    	echo $query_is;
					...
					<h3 style="text-transform: uppercase;text-align: center;font-weight: bold;">
						...
						<div class="wrap-img">
							...
							if( mysqli_num_rows($result) > 0 ) {
								...
								if( isset($gia_tri) && !empty($gia_tri)) {
