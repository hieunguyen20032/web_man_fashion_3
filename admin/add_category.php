...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(empty($errors))
            {
                $query ="SELECT ma_danh_muc FROM tb_danh_muc WHERE ma_danh_muc ='{$code}'";
                ...
                {
                    $query_in = "INSERT INTO tb_danh_muc(ma_danh_muc,ten_danh_muc,ten_khong_dau_danh_muc ,id_cha)
