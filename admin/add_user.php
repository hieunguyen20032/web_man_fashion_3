    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($errors)) {
                    $query = "SELECT tai_khoan_nguoi_dung FROM tb_nguoi_dung WHERE tai_khoan_nguoi_dung='{$taikhoan}'";
                    $result = mysqli_query($dbc, $query);
                    kt_query($query, $result);

                    $query2 = "SELECT email_nguoi_dung FROM tb_nguoi_dung WHERE email_nguoi_dung='{$email}'";
                    ...
                    // }
                        ...
                        $query_in = "INSERT INTO tb_nguoi_dung(tai_khoan_nguoi_dung,mat_khau_nguoi_dung,ten_nguoi_dung,ngay_sinh,cmnd_nguoi_dung,so_dien_thoai_nguoi_dung,email_nguoi_dung,dia_chi_nguoi_dung,loai_nguoi_dung,trang_thai_nguoi_dung)
