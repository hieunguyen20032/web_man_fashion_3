 ...
 var day = new Date();
    ...
    $(".statistic-chart .menu .kho").click(function(){
       ...
       $('.statistic-chart .menu .sub-menu').html(`
        ...
        <li> 
            <div class="print_kho"><button style="padding:10px 20px;background-color:green;color:white;border:none;">In</button></div> 
        </li>
        </ul>
       ...
       $.ajax({
        ...
        $('.print_kho').click(function(){ 
            var generator = window.open("in");
            generator.document.write($('.wrap-content').html());
            generator.print();
            generator.close();
        });
   });
