    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($errors)) {
                    $query_up = "UPDATE tb_nhan SET ma_nhan ='$code', ten_nhan='$name' WHERE id_nhan='$id'";
            ...
            //ket thuc submit
            $query = "SELECT * FROM tb_nhan WHERE id_nhan={$id}";
            ...
            <form name="frmadd-video" method="post">
                ...
                <h3 style="color: #FF0000">Chỉnh sửa - hiệu sản phẩm "<?php echo $dong['ten_nhan']; ?>"</h3>
                <div class="form-group">
                    <label>Mã loại sản phẩm</label>
                    <input type="text" name="code_label" value="<?php if (isset($_POST['code_label'])) {
                        echo $_POST['code_label'];
                    }
                    echo $dong['ma_nhan']; ?>" class="form-control" placeholder='Mã hiệu sản phẩm'/>
                </div>
                ...
                <div class="form-group">
                    ...
                    echo $dong['ten_nhan']; ?>" class="form-control" placeholder='Tên hiệu sản phẩm'/>
                </div>
