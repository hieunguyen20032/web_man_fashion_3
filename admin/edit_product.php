...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ( empty($errors) ) {
                ...
                $temp[1] = strtolower($temp[1]);
                    ...
                    $query_in = "UPDATE tb_san_pham SET 
                    ten_san_pham = '$name',
                    anh_san_pham = '$link_image',
                    anh_thumb    = '$link_image_thump',
                    gia_san_pham = '$price',
                    gia_khuyen_mai = '$saleprice',
                    mo_ta_san_pham = '$describe',
                    kich_co_san_pham = '$array_size',
                    trang_thai_san_pham = '$status',
                    id_danh_muc = " . $id_loai .",
                    id_nhan = {$label}
            ...
            //ket thuc submit
            $query = "SELECT * FROM tb_san_pham  WHERE id_san_pham={$id}";
         ...
         <form name="frmedit-product" method="post" enctype="multipart/form-data" class="frmedit-product">
            ...
            ?>
            <h3 style="color: red;">Chỉnh sửa - sản phẩm "<?php echo $dong['ten_san_pham']; ?>"</h3>
            <div class="form-group">
                <label>Tên sản phẩm</label>
                <input type="text" name="name_product" value="<?php echo $dong['ten_san_pham']; ?>"
            ...
            <div class="row">
                <div class="col-xs-4">
                    <div class="form-group wrap-category" id="<?php echo $dong['id_danh_muc']; ?>">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <select name="label_product" style='padding:5px 10px;border-radius:4px;display: block;'>
                            ...
                            <?php
                            $query_label = "SELECT* FROM tb_nhan";
                            ...
                            while ($label = mysqli_fetch_array($result_label, MYSQLI_ASSOC)) {
                                ...
                                value="<?php echo $label['id_nhan']; ?>" <?php if($label['id_nhan'] == $dong['id_nhan']) { echo "selected='selected'";} ?> ><?php echo $label['ten_nhan']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
            ...
            <div class="form-group">
                ...
                <div class="wrap-img">
                    <?php  
                    $array_img = explode(" ", $dong['anh_san_pham']);
                    $array_img_thumb =  explode(" ", $dong['anh_thumb']);
                        // echo "<pre>";
            ...
            <div class="form-group wrap-size">
             <?php 
             $type_size ='';
             if (isset($dong['kich_co_san_pham']) && !empty($dong['kich_co_san_pham']) ) {
                foreach (Unserialize($dong['kich_co_san_pham']) as $key => $value) {
                    if ( is_numeric( $key )) {
                        $type_size = 'number';
                        break;
                    } else {
            ...
            <div class="all-size">
                ...
                if (isset($dong['kich_co_san_pham']) && !empty($dong['kich_co_san_pham']) ) {
                    if( $type_size == 'text' ) {
                        temlate_size_text( Unserialize($dong['kich_co_san_pham']) );
                    } else {
                       temlate_size_number( Unserialize($dong['kich_co_san_pham']) );
                   }
               }
               ?>
           </div>
           <div class="form-group">
            ...
            echo number_format($dong['gia_san_pham']); ?>" class="form-control"
        ...
        <div class="form-group">
            ...
            echo number_format($dong['gia_khuyen_mai']); ?>" class="form-control"
        ...
        <div class="form-group">
            ...
            echo $dong['mo_ta_san_pham']; ?></textarea>
            <?php
        ...
        <div class="form-group">
            ...
            <label class="radio-inline"> 
                <input type="radio" name="status" value="1" <?php if ($dong['trang_thai_san_pham'] == '1') {
               echo 'checked = "checked"';
            } ?>/>
                <p class="results"> Còn hàng</p>
            </label>
            <label class="radio-inline"> 
               <input type="radio" name="status" value="0" <?php if ($dong['trang_thai_san_pham'] == '0') {
               echo 'checked = "checked"';
            } ?>/>
