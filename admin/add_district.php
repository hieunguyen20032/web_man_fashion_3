...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(empty($errors))
            {
                $query ="SELECT * FROM tb_quan_huyen WHERE ma_quan_huyen='{$code}' && id_thanh_pho = '{$city}' ";
                ...
                {
                    $query_in = "INSERT INTO tb_quan_huyen(ma_quan_huyen,ten_quan_huyen,id_thanh_pho)
