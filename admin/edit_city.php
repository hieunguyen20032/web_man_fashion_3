    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($errors)) {
                    $query_in = "UPDATE tb_thanh_pho SET ma_thanh_pho='$code', ten_thanh_pho='$name' where id_thanh_pho='$id'";
            ...
            //ket thuc submit
            $query = "SELECT * FROM tb_thanh_pho WHERE id_thanh_pho={$id}";
            ...
            <form name="frmadd-video" method="post">
                ...
                <h2 style=" color: red">Chỉnh sửa - thành phố "<?php echo $dong['ten_thanh_pho'] ?>"</h2>
                <div class="form-group">
                    <label>Mã loại sản phẩm</label>
                    <input type="text" name="code_city" value="<?php echo $dong['ma_thanh_pho']; ?>" class="form-control" placeholder='Mã thành phố'/>
                </div>

                <div class="form-group">
                    <label>Tên loại sản phẩm</label>
                    <input type="text" name="name_city" value="<?php echo $dong['ten_thanh_pho']; ?>" class="form-control" id="name_category" placeholder='Tên thành phố'/>
                </div>
