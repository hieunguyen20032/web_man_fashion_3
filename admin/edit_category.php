    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($errors)) {
                    $query_in = "UPDATE tb_danh_muc SET ma_danh_muc ='$code', ten_danh_muc ='$name',id_cha='$parent_id' where id_danh_muc ='$id'";
            ...
            //ket thuc submit
            $query = "SELECT * FROM tb_danh_muc WHERE id_danh_muc={$id}";
            ...
            <form name="frmadd-video" method="post">
                ...
                <h2 style=" color: red">Chỉnh sửa - loại sản phẩm "<?php echo $dong['ten_danh_muc'] ?>"</h2>
                <div class="form-group">
                    <label>Mã loại sản phẩm</label>
                    <input type="text" name="code_category" value="<?php if(isset($_POST['code_category'])) {echo $_POST['code_category'];} echo $dong['ma_danh_muc']; ?>" class="form-control" placeholder='Mã loại sản phẩm'/>
                </div>

                <div class="form-group">
                    <label>Tên loại sản phẩm</label>
                    <input type="text" name="name_category" value="<?php if(isset($_POST['name_category'])) {echo $_POST['name_category'];} echo $dong['ten_danh_muc']; ?>" class="form-control" id="name_category" current_id="<?php echo $id; ?>" parent_id="<?php echo $dong['id_cha'] ?>" placeholder='Tên loại sản phẩm'/>
                </div>
