...
<div class="row wrap-add-product">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if (isset($_POST['submit'])) {
            ...
            $id_product = 6;
            if (empty($errors)) {
                $query = "SELECT ten_san_pham FROM tb_san_pham WHERE ma_san_pham='{$name}'";
...
//                    echo "</pre>";
                    ...
                    $query_data = "INSERT INTO tb_san_pham(
                    ma_san_pham,
                    ten_san_pham,
                    anh_san_pham,   
                    anh_thumb,
    ...
    <div class="form-group">
        ...
        <select name="label_product" style='padding:5px 10px;border-radius:4px;display: block;'>
            ...
            while ($label = mysqli_fetch_array($result_label, MYSQLI_ASSOC)) {
                ...
                value="<?php echo $label['id_nhan']; ?>"><?php echo $label['ten_nhan']; ?></option>
                <?php
            }
            ?>
        </select>
